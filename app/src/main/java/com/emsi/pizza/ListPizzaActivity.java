...
import com.emsi.pizza.adapter.PizzaAdapter;
import com.emsi.pizza.bean.Produit;
import com.emsi.pizza.services.ProduitService;
...
public class ListPizzaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        produitService.create(new Produit("BARBECUED CHICKEN PIZZA",
                3, R.mipmap.pizza1,
                35,
                ...
                "So fast and so easy with refrigerated pizza crust," +
                        " these saucy, smoky pizzas make quick fans with their hot-off-the-grill," +
                        " rustic flavor. They're perfect for spur-of-the-moment cookouts and summer dinners on the patio." +
